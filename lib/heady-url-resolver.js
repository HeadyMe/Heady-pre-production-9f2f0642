...
// This module intercepts and kills localhost/127.x/.onrender.com
...
const DOMAIN_MAP = {
  ...
  'heady-manager-headysystems.onrender.com':    'https://api.app.headysystems.com',
  'heady-manager-headyme.onrender.com':         'https://api.app.headysystems.com/me',
  'heady-manager-headyconnection.onrender.com': 'https://api.app.headyconnection.org',
};
...
class HeadyUrlResolver {
  ...
  resolve(input, context = {}) {
    ...
    // 2. Replace localhost patterns with production domains
    resolved = resolved.replace(/https?:\/\/localhost:(\d+)/gi, (match, port) => {
