...
(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,87473,e=>{"use strict";var n=e.i(92208),a=e.i(49350);function t(){let[e,t]=(0,a.useState)([{role:"assistant",content:"Hello! I'm HeadyBuddy, your intelligent AI assistant. How can I help you today?"}]),[i,o]=(0,a.useState)(""),[s,r]=(0,a.useState)(!1),l=async()=>{if(!i.trim())return;let e={role:"user",content:i};t(n=>[...n,e]),o(""),r(!0),setTimeout(()=>{let e,n={role:"assistant",content:""};n.content=(e=i.toLowerCase()).includes("who are you")||e.includes("what are you")?`I'm HeadyBuddy, an advanced AI assistant integrated with the Heady ecosystem. I have access to:
...
I'm designed to help with literally anything - technical tasks, creative work, system management, or just conversation. What would you like to explore?`:e.includes("can you")||e.includes("able to")?`Yes, I can handle virtually any task! Here's what I'm capable of:
...
Basically, if you can think it, I can help you do it. What specific challenge or opportunity are you facing?`:e.includes("test")||e.includes("prove")?`Let me demonstrate my capabilities! 🔥
...
What would you like me to demonstrate?`:e.includes("deploy")||e.includes("build")?`🚀 **Deployment Intelligence Activated**
...
Ready to deploy? Just tell me what you want to accomplish and I'll handle the rest!`:e.includes("code")||e.includes("programming")||e.includes("develop")?`💻 **Development Intelligence Online**
...
What development challenge can I help you solve?`:e.includes("analyze")||e.includes("diagnose")||e.includes("check")?`🔍 **Advanced Analysis Mode**
...
What would you like me to analyze? I'll provide comprehensive insights and actionable recommendations.`:e.includes("create")||e.includes("make")||e.includes("build")?`🏗️ **Creation Engine Activated**
...
What would you like me to create? I'll build it intelligently and efficiently!`:e.includes("optimize")||e.includes("improve")||e.includes("enhance")?`⚡ **Optimization Intelligence**
...
What would you like me to optimize? I'll deliver measurable improvements!`:e.includes("future")||e.includes("roadmap")||e.includes("plan")?`🔮 **Strategic Foresight & Planning**
...
What future scenario would you like me to plan for? I'll provide comprehensive strategic guidance!`:`� **Intelligent Response System Activated**
...
Tell me more about what you'd like to accomplish, and I'll provide intelligent, actionable assistance. I'm ready to handle literally anything you throw at me! 🔥`,t(e=>[...e,n]),r(!1)},1e3)};return(0,n.jsxs)("div",{className:"min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900",children:[(0,n.jsx)("div",{className:"absolute inset-0 bg-[url('/bg-pattern.png')] opacity-20"}),(0,n.jsxs)("div",{className:"relative z-10 min-h-screen flex flex-col",children:[(0,n.jsx)("header",{className:"bg-black/30 backdrop-blur-lg border-b border-purple-500/30",children:(0,n.jsx)("div",{className:"max-w-6xl mx-auto px-4 py-4",children:(0,n.jsxs)("div",{className:"flex items-center gap-4",children:[(0,n.jsx)("div",{className:"w-12 h-12 bg-gradient-to-br from-purple-400 to-purple-600 rounded-xl flex items-center justify-center",children:(0,n.jsx)("span",{className:"text-xl font-bold text-white",children:"BU"})}),(0,n.jsxs)("div",{children:[(0,n.jsx)("h1",{className:"text-2xl font-bold text-white",children:"HeadyBuddy"}),(0,n.jsx)("p",{className:"text-purple-300",children:"Intelligent AI Assistant"})]})]})})}),(0,n.jsx)("div",{className:"flex-1 max-w-6xl mx-auto w-full px-4 py-8",children:(0,n.jsxs)("div",{className:"bg-black/30 backdrop-blur-lg border border-purple-500/30 rounded-2xl h-full flex flex-col",children:[(0,n.jsxs)("div",{className:"flex-1 p-6 overflow-y-auto",children:[e.map((e,a)=>(0,n.jsx)("div",{className:`mb-6 ${"user"===e.role?"text-right":"text-left"}`,children:(0,n.jsx)("div",{className:`inline-block max-w-2xl px-6 py-4 rounded-2xl ${"user"===e.role?"bg-gradient-to-r from-purple-600 to-pink-600 text-white":"bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 text-white"}`,children:(0,n.jsx)("p",{className:"whitespace-pre-line",children:e.content})})},a)),s&&(0,n.jsx)("div",{className:"text-left mb-6",children:(0,n.jsx)("div",{className:"inline-block px-6 py-4 rounded-2xl bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30",children:(0,n.jsxs)("div",{className:"flex gap-2",children:[(0,n.jsx)("div",{className:"w-2 h-2 bg-white rounded-full animate-bounce"}),(0,n.jsx)("div",{className:"w-2 h-2 bg-white rounded-full animate-bounce delay-100"}),(0,n.jsx)("div",{className:"w-2 h-2 bg-white rounded-full animate-bounce delay-200"})]})})})]}),(0,n.jsx)("div",{className:"p-6 border-t border-purple-500/30",children:(0,n.jsxs)("div",{className:"flex gap-4",children:[(0,n.jsx)("input",{type:"text",value:i,onChange:e=>o(e.target.value),onKeyPress:e=>"Enter"===e.key&&l(),placeholder:"Ask HeadyBuddy anything...",className:"flex-1 bg-black/50 border border-purple-500/30 rounded-xl px-6 py-4 text-white placeholder-gray-400 focus:outline-none focus:border-purple-400 transition-colors"}),(0,n.jsx)("button",{onClick:l,disabled:!i.trim()||s,className:"bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-xl font-bold hover:from-purple-700 hover:to-pink-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed",children:"Send"})]})})]})})]})]})}e.s(["default",()=>t])}]);
